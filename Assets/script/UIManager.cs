...
public class UIManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject mainMenu, gameMenu, gameOverPanel, retryBtn, nextBtn,kembali;   //important gameobjects
    ...
    public void GameResult()
    {
        switch (GameManager.singleton.gameStatus)
        {
            ...
            case GameStatus.Failed:                         //if failed
                ...
                break;
		case GameStatus.kembali:                         //if failed
			gameOverPanel.SetActive(true);              //activate game finish panel
			kembali.SetActive(true);                   //activate retry button
			SoundManager.instance.PlayFx(FxTypes.GAMEOVERFX);
			break;
        }
    }
    ...
    public void NextRetryBtn(string scene)
    {
        SceneManager.LoadScene(SceneManager.GetActiveScene().buildIndex);
